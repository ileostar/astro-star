<h1 align="center">🟢 Astro-starter</h1>
...
Here is a list of core dependencies that astro-star relies on in case you need to extend the starter/look into more documentation:
...
astro-star is an opinionated Astro starter, meaning it ships with a pre-determined file structure and procedure for doing things. In this getting started guide we'll walk you through how to use the starter for your project.
...
astro-star ships with an SEO configuration file to setup defaults for your website!
...
Make sure you fully customize every recommended field to take full advantage of astro-star's built-in SEO optimization!
...
One the best features of astro-star is its extensive list of import aliases.
...
This documentation looks at astro-star from a top-down perspective, providing insight into every directory and file available in the base starter.
